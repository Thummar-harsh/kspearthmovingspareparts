        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Delivering high-quality, cost-effective replacement parts to
              dealers, distributors, and procurement managers worldwide since
              2013.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Established in 2013, we are a leading Manufacturer, Supplier &
                Exporter of premium earthmoving spare parts. Our mission is to
                expand our global dealer network while delivering on-time,
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">
                      Advanced forging, CNC, VMC, and hardening facilities
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">
                      Serving dealers across India and international markets
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive range of high-quality spare parts for all major
      ...
      <section className="py-20 bg-gradient-to-br from-brand-red to-red-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-red-100">
            Join 150+ dealers worldwide who trust us for quality earthmoving
            spare parts
          </p>
          <button
            onClick={() => onNavigate("contact")}
