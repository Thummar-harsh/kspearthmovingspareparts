...
export default function Manufacturing() {
  const capabilities = [
    {
      ...
      description:
        "High-strength component production with controlled grain structure",
    ...
    },
    {
      ...
      description:
        "Computer-controlled precision machining for complex geometries",
      features: [
    ...
    },
    {
      ...
      description:
        "Vertical machining center for versatile component production",
  ...
  const processes = [
    ...
    },
    {
      ...
      description:
        "Precision manufacturing using advanced CNC and VMC equipment",
    },
    {
      step: "03",
    ...
    },
    {
      ...
      title: "Finishing",
      description:
        "Precision grinding and surface treatment for exact specifications",
    },
    {
      step: "05",
    ...
    },
    {
      ...
      description:
        "Secure packaging and on-time delivery to global destinations",
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300">
              State-of-the-art production processes ensuring precision, quality,
              and reliability
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Advanced machinery and expert craftsmanship delivering precision
              components
            </p>
          </div>
            ...
            {capabilities.map((capability, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-brand-red font-bold mb-4">
                    {capability.capacity}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                ...
                manufacturing process. From material selection to final
                inspection, we maintain the highest standards to ensure
            ...
            <div className="bg-gradient-to-br from-brand-red to-red-800 text-white p-8 md:p-12 rounded-2xl">
              ...
              <div className="mt-8 pt-6 border-t border-red-700">
                <p className="text-red-100">
                  ...
                  technology and operated by skilled technicians committed to
      ...
      <section className="py-20 bg-gradient-to-br from-brand-red to-red-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-red-100">
            Partner with us for precision components manufactured to the highest
            standards
          </p>
